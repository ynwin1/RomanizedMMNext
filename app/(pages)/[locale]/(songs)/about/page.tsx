...
const Page = ({params} : AboutPageProps) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="border-2 border-orange-200 p-4 rounded-2xl space-y-4 mt-6 leading-8 w-[80vw] text-left text-[1rem] md-max:text-sm md-max:w-[80vw]">
                {locale === "en" ?
                    <>
                        ...
                        <li><p><b>Romanized</b>: For folks who want to sing along.</p></li>
                        <li><p><b>Burmese</b>: For those who want to learn Burmese or just casually browse.</p></li>
                        <li><p><b>Meaning</b>: For people who want to know the meaning behind the lyrics.</p></li>
                    ...
                    <>
                        ...
                        <li><p><b>Romanized</b>: လိုက်ဆိုချင်ပေမယ့် မြန်မာစာ မဖတ်တတ်တဲ့သူတွေ အတွက်ပါ</p></li>
                        <li><p><b>Burmese</b>: ဒါကတော့ မြန်မာတွေ အတွက်ပါ</p></li>
                        <li><p><b>Meaning</b>: ဒီမှာကတော့ သီချင်စာသားတွေရဲ့ အဓိပ္ပာယ်တွေပါ။ မြန်မာစာလေ့လာသူတွေအတွက်လဲ အထောက်အကူဖြစ်မယ် ထင်ပါတယ်။</p></li>
